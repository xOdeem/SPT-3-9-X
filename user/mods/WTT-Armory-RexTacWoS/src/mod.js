...
class WTTArmoryRexTacWoS {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] "For the wages of sin...is death"`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new WTTArmoryRexTacWoS() };
