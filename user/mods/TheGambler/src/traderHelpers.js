    ...
    addSingleItemsToTrader(tables, traderId, assortCreator, container, logger) {
        ...
        if (config.price_stock['weapon_case_enable']) {
            assortCreator.createSingleAssortItem(WEAPON_GAMBLE_ID)
                ...
                .addMoneyCost(Money_1.Money.ROUBLES, (config.price_stock['weapon_case_price'] * config.price_multiplier))
                .addLoyaltyLevel(1)
                .export(tables.traders[baseJson._id]);
        }
        ...
        if (config.price_stock['premium_weapon_case_enable']) {
            assortCreator.createSingleAssortItem(PREMIUM_WEAPON_GAMBLE_ID)
                ...
                .addMoneyCost(Money_1.Money.ROUBLES, (config.price_stock['premium_weapon_case_price'] * config.price_multiplier))
                .addLoyaltyLevel(1)
                .export(tables.traders[baseJson._id]);
        }
        ...
        if (config.price_stock['loadout_case_enable']) {
            assortCreator.createSingleAssortItem(LOADOUT_GAMBLE_ID)
                ...
                .addMoneyCost(Money_1.Money.ROUBLES, (config.price_stock['loadout_case_price'] * config.price_multiplier))
                .addLoyaltyLevel(1)
                .export(tables.traders[baseJson._id]);
        }
